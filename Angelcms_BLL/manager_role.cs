...
namespace Angelcms.BLL
{
    ...
    public partial class manager_role
    {
        ...
        {
            Age_manager_role model = dal.GetModel(role_id);
            if (model != null)
            {
                ...
                Age_manager_role_value modelt = model.manager_role_values.Find(p => p.nav_name == nav_name && p.action_type == action_type);
                if (modelt != null)
                {
                    return true;
                }
