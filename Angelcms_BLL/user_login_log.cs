...
namespace Angelcms.BLL
{
    ...
    public partial class user_login_log
    {
        ...
        {
            Age_user_login_log model = new Age_user_login_log();
            model.user_id = user_id;
            model.user_name = user_name;
            model.remark = remark;
            model.login_ip = AgeRequest.GetIP();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_user_login_log model)
        {
            return dal.Add(model);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_user_login_log GetModel(int id)
        {
        ...
        /// 根据用户名取得最后登录的MODEL
        /// </summary>
        public Age_user_login_log GetLastModel(string user_name)
        {
