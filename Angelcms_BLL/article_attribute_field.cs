...
namespace Angelcms.BLL
{
    ...
    public partial class article_attribute_field
    {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Age_article_attribute_field> GetModelList(int channel_id, string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Age_article_attribute_field> DataTableToList(DataTable dt)
        {
            List<Age_article_attribute_field> modelList = new List<Age_article_attribute_field>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Age_article_attribute_field model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Age_article_attribute_field();
