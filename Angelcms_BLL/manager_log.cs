...
namespace Angelcms.BLL
{
    ...
    public partial class manager_log
    {
        ...
        {
            Age_manager_log manager_log_model = new Age_manager_log();
            ...
            manager_log_model.user_ip = AgeRequest.GetIP();
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_manager_log model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_manager_log GetModel(int id)
        {
        ...
        /// 根据用户名返回上一次登录记录
        /// </summary>
        public Age_manager_log GetModel(string user_name, int top_num, string action_type)
        {
