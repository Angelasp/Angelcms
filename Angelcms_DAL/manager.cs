...
namespace Angelcms.DAL
{
    ...
    public partial class manager
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_manager model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_manager model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_manager GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public Age_manager GetModel(string user_name, string password)
        {
            StringBuilder strSql = new StringBuilder();
