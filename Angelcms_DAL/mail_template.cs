...
namespace Angelcms.DAL
{
    ...
    public partial class mail_template
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_mail_template model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_mail_template model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_mail_template GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_mail_template GetModel(string call_index)
        {
            StringBuilder strSql = new StringBuilder();
