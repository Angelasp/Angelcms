...
namespace Angelcms.DAL
{
    ...
    public partial class user_amount_log
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_user_amount_log model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_user_amount_log model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_user_amount_log GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Age_user_amount_log model = new Age_user_amount_log();
        ...
        /// 根据订单号返回一个实体
        /// </summary>
        public Age_user_amount_log GetModel(string order_no)
        {
            StringBuilder strSql = new StringBuilder();
