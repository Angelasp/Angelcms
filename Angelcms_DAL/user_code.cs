...
namespace Angelcms.DAL
{
    ...
    public partial class user_code
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_user_code model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_user_code model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_user_code GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Age_user_code model = new Age_user_code();
        ...
        /// 根据生成码得到一个对象实体
        /// </summary>
        public Age_user_code GetModel(string str_code)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 根据用户名得到一个对象实体
        /// </summary>
        public Age_user_code GetModel(string user_name, string code_type, string datepart)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from " + databaseprefix + "user_code");
