...
namespace Angelcms.DAL
{
    ...
    public partial class user_oauth
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_user_oauth model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_user_oauth model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_user_oauth GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Age_user_oauth model = new Age_user_oauth();
        ...
        /// 根据开放平台和openid返回一个实体
        /// </summary>
        public Age_user_oauth GetModel(string oauth_name, string oauth_openid)
        {
            StringBuilder strSql = new StringBuilder();
