    ...
    public partial class users
    {
        ...
        public string GetSalt(string user_name)
        {
            ...
            SqlParameter[] parameters = {
                    new SqlParameter("@user_name", SqlDbType.NVarChar,100)};
            parameters[0].Value = user_name;
            string salt = Convert.ToString(DbHelperMSSQL.GetSingle(strSql.ToString(), parameters));
            ...
            salt = Convert.ToString(DbHelperMSSQL.GetSingle(strSql1.ToString(), parameters1));
            if (!string.IsNullOrEmpty(salt))
            {
                return salt;
            }
            ...
            salt = Convert.ToString(DbHelperMSSQL.GetSingle(strSql2.ToString(), parameters2));
            if (!string.IsNullOrEmpty(salt))
            {
                return salt;
            }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Age_users model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Age_users model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Age_users GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 根据用户名密码返回一个实体
        /// </summary>
        public Age_users GetModel(string user_name, string password, int emaillogin, int mobilelogin)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 根据用户名返回一个实体
        /// </summary>
        public Age_users GetModel(string user_name)
        {
            StringBuilder strSql = new StringBuilder();
