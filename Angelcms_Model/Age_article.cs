...
{
	/// <summary>
	/// Age_article:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Age_article
	{
		public Age_article()
		{}
		#region Model
        ...
        /// 图片相册
        /// </summary>
        private List<Age_article_albums> _albums;
        public List<Age_article_albums> albums
        {
            set { _albums = value; }
            get { return _albums; }
        }
        ...
        /// 内容附件
        /// </summary>
        private List<Age_article_attach> _attach;
        public List<Age_article_attach> attach
        {
            set { _attach = value; }
            get { return _attach; }
        }

        private List<Age_user_group_price> _group_price;
        /// <summary>
        /// 会员组价格
        /// </summary>
        public List<Age_user_group_price> group_price
        {
