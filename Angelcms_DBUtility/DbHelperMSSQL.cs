...
namespace Angelcms_DBUtility
{
    public abstract class DbHelperMSSQL
    {
        ...
        public static int GetMinID(string FieldName, string TableName)
        {
            ...
            object obj = DbHelperMSSQL.GetSingle(strsql);
            if (obj == null)
            {
                return 0;
            }
        ...
        {
            object obj = DbHelperMSSQL.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// <summary>
        /// 2013-2-21新增重载，执行SQL语句，返回影响的记录数
        /// </summary>
        ...
        /// <summary>
        /// 2013-2-21新增重载，执行查询语句，返回DataSet
        /// </summary>
        /// <param name="connection">SqlConnection对象</param>
        ...
        /// <summary>
        /// 2013-2-29新增重载，执行SQL语句，返回影响的记录数
        /// </summary>
        /// <param name="connection">SqlConnection对象</param>
