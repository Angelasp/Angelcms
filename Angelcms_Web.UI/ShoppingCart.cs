...
namespace Angelcms.Web.UI
{
    ...
    public partial class ShopCart
    {
        ...
        public static IList<Model.cart_items> GetList(int group_id)
        {
            ...
            if (dic != null)
            {
                ...
                foreach (var item in dic)
                {
                    ...
                    Age_article model = bll.GetModel(Convert.ToInt32(item.Key));
                    ...
                    {
                        Age_user_group_price gmodel = model.group_price.Find(p => p.group_id == group_id);
                        if (gmodel != null)
                        {
        ...
        public static void Clear(string Key)
        {
            ...
            {
                Utils.WriteCookie(AgeKeys.COOKIE_SHOPPING_CART, "", -43200);
            }
            else
            {
                IDictionary<string, int> dic = GetCart();
        ...
        {
            Utils.WriteCookie(AgeKeys.COOKIE_SHOPPING_CART, strValue, 43200); //存储一个月
        }
        ...
        {
            return Utils.GetCookie(AgeKeys.COOKIE_SHOPPING_CART);
        }
