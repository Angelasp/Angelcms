...
namespace Angelcms.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[AgeKeys.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(AgeKeys.COOKIE_USER_NAME_REMEMBER, "Angelcms", -43200);
                Utils.WriteCookie(AgeKeys.COOKIE_USER_PWD_REMEMBER, "Angelcms", -43200);
                Utils.WriteCookie("UserName", "Angelcms", -1);
                Utils.WriteCookie("Password", "Angelcms", -1);
                //自动登录,跳转URL
