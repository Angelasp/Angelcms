...
namespace Angelcms.Web.UI.Page
{
    public partial class search : Web.UI.BasePage
    {
        ...
        protected override void ShowPage()
        {
            ...
            keyword = AgeRequest.GetQueryStringValue("keyword");
            channel_name = AgeRequest.GetQueryStringValue("channel_name");
        }
        ...
        private string get_url_rewrite(int channel_id, string call_index, int id)
        {
            ...
            Age_url_rewrite model = bll.GetInfo(channel_name, "detail");
            if (model != null)
            {
