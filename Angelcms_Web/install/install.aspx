<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="install.aspx.cs" Inherits="Angelcms_Web.install.install" %>
...
<body>
<div class="wrap cl">
	<h2><img alt="Angelcms!NT|Angel工作室|asp.net网站管理系统" src="images/logo.png" /><cite><b><%=Angelcms_Common.Utils.GetVersion()%></b>安装程序</cite></h2>
	<div class="nav">
        <ul>
    ...
    <%if(stepNum== 0)
      { %>
	<div class="main cl">
		<h1>欢迎使用Angelcms!NT内容关系管理系统</h1>
        <div class="inner">
            <h2>Angelcms!NT代码使用协议</h2>
            <strong>版权所有 (c) 2009-2014，Angel工作室,保留所有权利</strong>。 
            <br>
            <br>
            <p>感谢您选择Angelcms!NT网站系统，希望我们的努力能为您提供一个高效快速和强大的建站解决方案。 </p>
            <p>Angel工作室 为 Angelcms!NT 产品的开发商，依法独立拥有 Angelcms!NT产品著作权。Angel工作室网址为 <a href="http://www.angelasp.com" target="_blank">http://www.angelasp.com</a>， Angelcms!NT 官方博客地址为 <a href="http://hi.baidu.com/angelcms" target="_blank">http://hi.baidu.com/angelcms</a>。 </p>
            <p>Angelcms!NT 开源CMS。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 Angelcms!NT 软件。 </p>
            <p>本授权协议适用且仅适用于 Angelcms!NT 1.0 版本，Angel工作室拥有对本授权协议的最终解释权。 <br></p>
            <p></p>
            <h2>协议许可的权利</h2>
                1) 您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付费用。 <br>
            <br>
            2) 您可以在协议规定的约束和限制范围内修改 Angelcms!NT 源代码(如果被提供的话)或界面风格以适应您的网站要求。 <br>
            <br>
            3) 您拥有使用本软件构建的网站全部会员资料、文章及相关信息的所有权，并独立承担与文章内容的相关法律义务。 <br>
            <br>
            ...
            <p></p>
            <h2>协议规定的约束和限制</h2>
            1) 未获商业授权之前，不得将本软件用于商业用途（包括但不限于公司网站、经营性网站、以营利为目或实现盈利的网站）。 <br>
            <br>
            2) 不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。 <br>
            <br>
            3) 无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用 Angelcms!NT 的整体或任何部分，未经书面许可，论坛页面页脚处的 Angelcms!NT 名称和Angel工作室网站（http://www.angelasp.com） 的链接都必须保留，而不能清除或修改。<br> 
            <br>
            4) 禁止在 Angelcms!NT 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。 与其它条款无抵触的前提下，允许以自用为目的的进行进行二次开发或整合，但同样受前文第3项约束和限制，即保留Angelcms!NT名称与链接。<br>
            <br>
            ...
            <br>
            3) Angel工作室不对使用本软件构建的网站中的文章或信息承担责任。<br>
            <br>
            有关 Angelcms!NT 最终用户授权协议、商业授权与技术服务的详细内容，均由 Angelcms!NT 官方网站独家提供。Angel工作室拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。 
            <p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 Angelcms!NT，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。 <br>
            <br>
            </p>
            <h2>附：</h2>
                Angel工作室网址：<a href="http://www.angelasp.com" target="_blank">http://www.angelasp.com</a><br>
                Angelcms!NT官方博客：<a href="http://hi.baidu.com/angelcms" target="_blank">http://hi.baidu.com/angelcms</a><br>
        </div>
	</div>
	<div class="btn cl">
    ...
    <script type="text/javascript">
        ...
        function checkDbAjax(sqlip, sqlname, loginname, password, tableprefix) {
            ...
            showbox.show();
            jQuery.get('ajax.ashx', { 't': 'checkdbconnection', 'ip': sqlip, 'name': sqlname, 'loginname': loginname, 'loginpwd': password, 'time': Math.random() },
            function (data) {
        ...
        function DBSourceExist(sqlip, sqlname, loginname, password, tableprefix) {
            ...
            jQuery.get('ajax.ashx', { 't': 'dbsourceexist', 'ip': sqlip, 'name': sqlname, 'loginname': loginname, 'loginpwd': password, 'prefix': tableprefix, 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        showbox.hide();
                        runstep = 0;
                        Boxy.confirm('系统检测到数据库"' + sqlname + '"已经包含网站系统所需的数据表,继续安装会清空之前数据,是否继续?',
                        function on() {
        ...
        function checkDBCollation(sqlip, sqlname, loginname, password, tableprefix) {
            ...
            jQuery.get('ajax.ashx', { 't': 'checkdbcollation', 'ip': sqlip, 'name': sqlname, 'loginname': loginname, 'loginpwd': password, 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        setTimeout(function on() {
        ...
        function createDbAjax(sqlip, sqlname, loginname, password, tableprefix) {
            ...
            jQuery.get('ajax.ashx', { 't': 'createdb', 'ip': sqlip, 'name': sqlname, 'loginname': loginname, 'loginpwd': password, 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        createdDb = 1;
        ...
        function saveDbSet(sqlip, sqlname, loginname, password, tableprefix) {
            ...
            jQuery.get('ajax.ashx', { 't': 'savedbset', 'ip': sqlip, 'name': sqlname, 'loginname': loginname, 'loginpwd': password, 'prefix': tableprefix, 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        setTimeout(function on() {
    ...
    <script type="text/javascript">
        ...
        function createTable() {
            jQuery.get('ajax.ashx', { 't': 'createtable', 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        setTimeout(function on() {
...
<%
//        function createSP() {
//            jQuery.get('ajax.ashx', { 't': 'createsp', 'time': Math.random() },
//                function (data) {
//                    var callback = eval("(" + data + ")");
//                    if (callback.result) {
//                        setTimeout(function on() {
...
%>
        function initSource() {
            jQuery.get('ajax.ashx', { 't': 'initsource', 'admin': adminname, 'pwd': adminpassword, 'time': Math.random() },
                function (data) {
                    var callback = eval("(" + data + ")");
                    if (callback.result) {
                        setTimeout(function on() {
    ...
    <%} %>
	<div class="copy">
		Angel工作室 &copy; 2009 - 2014 angelasp Inc. 
	</div>
</div>
</body>
</html>
