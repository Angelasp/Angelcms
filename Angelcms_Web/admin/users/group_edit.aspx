<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_edit.aspx.cs" Inherits="Angelcms.Web.admin.users.group_edit" %>
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="group_list.aspx" class="back"><i></i><span>返回列表页</span></a> <a href="../systemmain.aspx"
