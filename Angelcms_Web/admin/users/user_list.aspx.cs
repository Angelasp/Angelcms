...
namespace Angelcms.Web.admin.users
{
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.group_id = AgeRequest.GetQueryInt("group_id");
        ...
        //        if (cb.Checked)
        //        {
        //            Age_users model = bll.GetModel(id);
        ...
        //    {
        //        Response.Redirect("user_sendemail.aspx?mobiles=" + Utils.UrlEncode(Utils.DelLastComma(str.ToString())));
        //    }
        //}
        ...
        {
            ChkAdminLevel("user_list", AgeEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.users bll = new BLL.users();
            for (int i = 0; i < rptList.Items.Count; i++)
            ...
            AddAdminLog(AgeEnums.ActionEnum.Delete.ToString(), "删除用户" + sucCount + "条，失败" + errorCount + "条"); //记录日志
