...
{
    public partial class article_list : Angelcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.category_id = AgeRequest.GetQueryInt("category_id");
            this.keywords = AgeRequest.GetQueryString("keywords");
            this.property = AgeRequest.GetQueryString("property");
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            BLL.article bll = new BLL.article();
            Age_article model = bll.GetModel(id);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(AgeEnums.ActionEnum.Edit.ToString(), "保存" + this.channel_name + "频道内容排序"); //记录日志
        ...
        {
            ChkAdminLevel("channel_" + this.channel_name + "_list", AgeEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0; //成功数量
            ...
            AddAdminLog(AgeEnums.ActionEnum.Edit.ToString(), "删除" + this.channel_name + "频道内容成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
