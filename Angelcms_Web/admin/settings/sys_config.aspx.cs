...
namespace Angelcms.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("site_config", AgeEnums.ActionEnum.View.ToString()); //检查权限
                ShowInfo();
            }
        }
        ...
        private void ShowInfo()
        {
            ...
            Age_siteconfig model = bll.loadConfig();
        ...
        {
            ChkAdminLevel("site_config", AgeEnums.ActionEnum.Edit.ToString()); //检查权限
            BLL.siteconfig bll = new BLL.siteconfig();
            Age_siteconfig model = bll.loadConfig();
            try
            {
                ...
                AddAdminLog(AgeEnums.ActionEnum.Edit.ToString(), "修改系统配置信息"); //记录日志
