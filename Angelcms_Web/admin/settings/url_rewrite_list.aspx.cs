...
namespace Angelcms.Web.admin.settings
{
    public partial class url_rewrite_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel = AgeRequest.GetQueryString("channel");
            this.type = AgeRequest.GetQueryString("type");
        ...
        {
            ChkAdminLevel("site_url_rewrite", AgeEnums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(AgeEnums.ActionEnum.Delete.ToString(), "删除URL配置信息"); //记录日志
