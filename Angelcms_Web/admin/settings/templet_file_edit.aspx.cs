...
namespace Angelcms.Web.admin.settings
{
    public partial class templet_file_edit : Web.UI.ManagePage
    {
        ...
        {
            pathName = AgeRequest.GetQueryString("path");
            fileName = AgeRequest.GetQueryString("filename");
        ...
        {
            ChkAdminLevel("app_templet_list", AgeEnums.ActionEnum.Edit.ToString()); //检查权限
            ...
            AddAdminLog(AgeEnums.ActionEnum.Edit.ToString(), "修改模板文件:" + this.fileName);//记录日志
