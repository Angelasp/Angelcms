<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="builder_html.aspx.cs" Inherits="Angelcms.Web.admin.settings.builder_html" %>
...
<ItemTemplate>
  ...
  <tr>
    ...
    <td>
      <a href="javascript:;" url="../../tools/admin_ajax.ashx?action=get_builder_urls&lang=<%#Eval("build_path")%>&name=&type=feedback" onclick="builerTip(this);">生成留言</a>
      |       <a href="javascript:;" url="../../tools/admin_ajax.ashx?action=get_builder_urls&lang=<%#Eval("build_path")%>&name=&type=linkindex" onclick="builerTip(this);">生成友情连接</a>
