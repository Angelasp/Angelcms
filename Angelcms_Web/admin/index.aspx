<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Angelcms.Web.admin.index" %>
...
//        //检测IE
                ...
                $(this).children("li").each(function () {
                    ...
                    if (liObj.children("ul").length > 0) { //如果有下级菜单
                        ...
                        liObj.children("a").click(function () {
                            ...
                            $(this).addClass("selected");
                            //保存到cookie
                            addCookie("Age_manage_navigation_cookie", $(this).attr("navid"), 240);
                        });
                    }
                });
                //显示第一个UL
    ...
    function linkMenuTree(islink, navid) {
        ...
        if (argument == 2) {
            ...
            cookieObj = $("#sidebar-nav").find('a[navid="' + getCookie("Age_manage_navigation_cookie") + '"]');
        }
        if (cookieObj.length > 0) {
            ...
            //检查是否需要保存到cookie
            if (argument == 2) {
                addCookie("Age_manage_navigation_cookie", navid, 240);
            }
            //检查是否需要跳转链接
            if (islink == true) {
            ...
            $("#sidebar-nav .list-box .list-group ul li a").removeClass("selected");
            //保存到cookie
            addCookie("Age_manage_navigation_cookie", "", 240);
        }
    }
    //初始化快捷导航菜单
...
<div style="background:url(images/topbg.gif) repeat-x;" class="header">

    <div class="topleft">
    <a href="center.aspx" target="mainframe"><img src="images/logo.png" title="系统首页" /></a>
    </div>
    ...
    <ul>
      ...
      <li class="help"><span><img src="images/help.png" title="帮助"  class="helpimg"/></span><a href="http://www.angelasp.com/" target="mainframe">帮助</a></li>

    </ul>
     
    <div class="user">
    <span>您好！<%=admin_info.user_name %></span>
    <i> <%=new Angelcms.BLL.manager_role().GetTitle(admin_info.role_id) %></i>
    </div>    
...
<div class="main-container">
  <iframe id="mainframe" name="mainframe" frameborder="0" src="systemmain.aspx"></iframe>
</div>
</form>

<div class="bottombg" style="display:block;height:24px;background-image:url('skin/default/main_47.gif');">
<div class="bottom_left"><span class="footerleft">版本 V1.1</span></div>
<div class="bottom_right"><a href="http://www.angelasp.com/" target="_blank">Angel工作室CMS内容管理系统</a></div>
</div>
</body>
</html>