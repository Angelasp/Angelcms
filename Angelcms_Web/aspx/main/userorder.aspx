<%@ Page Language="C#" AutoEventWireup="true" Inherits="Angelcms.Web.UI.Page.userorder" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	List<Angelcms.Model.Age_article> ls = get_order_goods_list(Utils.StrToInt(Utils.ObjectToStr(dr["id"]), 0));

	if (ls!=null)
	{

	foreach(Angelcms.Model.Age_article modelt in ls)
	{

	templateBuilder.Append("\r\n          <a target=\"_blank\" title=\"");
	templateBuilder.Append(Utils.ObjectToStr(modelt.title));
	templateBuilder.Append("\" href=\"");
	templateBuilder.Append(linkurl("products_show",modelt.id));
