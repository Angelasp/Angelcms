<%@ Page Language="C#" AutoEventWireup="true" Inherits="Angelcms.Web.UI.Page.article_list" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	string category_title = get_category_title(category_id,"公司产品");
	...
	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\"><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" /></a></div>\r\n							<div class=\"des\">\r\n						<p class=\"default\"><a href=\"");
	templateBuilder.Append(linkurl("photo_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(dr["title"]) + "</a></p>\r\n																<p class=\"default catalog\">" + Utils.ObjectToStr(dr["zhaiyao"]) + "</p>\r\n							</div>\r\n						</li>\r\n\r\n          ");
	}	//end for if

	templateBuilder.Append("\r\n\r\n\r\n				<ul>\r\n\r\n <div class=\"line20\"></div>		\r\n<div class=\"pager clearfix\">\r\n<div class=\"list\">\r\n");
	templateBuilder.Append(Utils.ObjectToStr(pagelist));
	templateBuilder.Append("	\r\n</div>\r\n</div>\r\n	</div>\r\n			<div class=\"block-foot\"><div><div>-</div></div></div>\r\n			</div>\r\n			\r\n		</div>\r\n		</div>\r\n		<div class=\"col-sub\">\r\n			<div class=\"block first-block block-products  list-240\" id=\"block-products-89305\" rel=\"89305\">    <div class=\"block-head\">    \r\n			<div class=\"head-inner\">\r\n	    	<h2 class=\"title\">图片类别</h2><div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("photo"));
