<%@ Page Language="C#" AutoEventWireup="true" Inherits="Angelcms.Web.UI.Page.index" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n<!--/Header-->\r\n<!--中间区块-->\r\n<div id=\"content-block\">\r\n<div class=\"content-block-width\">\r\n	<div id=\"bd\">\r\n	<div id=\"homepg\" class=\"bd-inner\">\r\n    <!--检查这里是否为一样-->\r\n	<div class=\"clearfix layout-home three-cols\">	<div class=\"col-main\">\r\n		<div class=\"main-wrap\">\r\n			<div class=\"block first-block block-diy list-410\" id=\"block-diy-89295\" rel=\"89295\">\r\n    <div class=\"block-head\">\r\n	    <div class=\"head-inner\">\r\n	    	<h2 class=\"title\">关于我们</h2>\r\n	    	    \r\n	    </div>\r\n    </div>\r\n    <div class=\"block-content clearfix\">\r\n    	<div class=\"content-text\">\r\n        ");
	DataTable aboutlist = get_article_list("about", 0, 0, "id=1 and status=0");

	foreach(DataRow dr in aboutlist.Rows)
	{

	templateBuilder.Append(Utils.DropHTML(Utils.ObjectToStr(dr["content"]),380));

	}	//end for if

	templateBuilder.Append("		\r\n		</div>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div></div></div></div>\r\n </div><div class=\"block last-block block-products list-410\" id=\"block-products-89298\" rel=\"89298\">\r\n    <div class=\"block-head\">\r\n	<div class=\"head-inner\">\r\n	<h2 class=\"title\">热门产品</h2>\r\n	<div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("products"));

	templateBuilder.Append("\">更多</a></div> \r\n	</div>\r\n	</div>\r\n    <div class=\"block-content clearfix\">\r\n\r\n<ul class=\"list-gallery clearfix\">\r\n\r\n");
	DataTable redproducts = get_article_list("products", 0, 3, "status=0 and is_hot=1");
	...
	templateBuilder.Append("\" ><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" width=\"100%\" /></a></div>\r\n<div class=\"des\"><p class=\"default\"><a href=\"");
	templateBuilder.Append(linkurl("products_show",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\" >" + Utils.ObjectToStr(dr["title"]) + "</a></p></div>\r\n</li>\r\n");
	}	//end for if

	templateBuilder.Append("\r\n\r\n</ul>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div></div></div></div>\r\n </div>		</div>\r\n	</div>\r\n	<div class=\"col-sub\">\r\n   		<div class=\"block first-block block-products  list-270\" id=\"block-products-89294\" rel=\"89294\">    <div class=\"block-head\">    <div class=\"head-inner\">\r\n	    	<h2 class=\"title\">产品分类</h2><div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("products"));

	templateBuilder.Append("\">更多</a></div>    \r\n			</div>\r\n    </div> \r\n	<div class=\"block-content clearfix\">\r\n    	<div class=\"item-list\">\r\n	    <ul class=\"clearfix\">\r\n	");
	DataTable category_list1 = get_category_child_list("products", 0);
	...
	templateBuilder.Append("\r\n			   <li>\r\n			   <a title=\"" + Utils.ObjectToStr(cdr1["title"]) + "\" href=\"");
	templateBuilder.Append(linkurl("products_list",Utils.ObjectToStr(cdr1["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(cdr1["title"]) + "</a>\r\n			    </li>			    	\r\n   ");
	}	//end for if

	templateBuilder.Append("													\r\n</ul>  \r\n</div>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div>-</div></div></div></div><div class=\"block last-block block-diy list-270\" id=\"block-diy-89297\" rel=\"89297\">\r\n    <div class=\"block-head\">\r\n	    <div class=\"head-inner\">\r\n	    	<h2 class=\"title\">联系我们</h2>\r\n	    </div>\r\n    </div>\r\n    <div class=\"block-content clearfix\">\r\n    	<div class=\"content-text\">\r\n公司名称：");
	...
	templateBuilder.Append("<br />\r\n邮箱：<a href=\"mailto:web@aaaa.com\">");
	templateBuilder.Append(Utils.ObjectToStr(config.webmail));
	templateBuilder.Append("</a><br />\r\n</div>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div></div></div></div>\r\n </div>	</div>\r\n	<div class=\"col-extra\">\r\n		<div class=\"block first-block block-articles  list-250\" id=\"block-articles-89296\" rel=\"89296\">    <div class=\"block-head\">    <div class=\"head-inner\">\r\n	    	<h2 class=\"title\">最新文章</h2><div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("news"));

	templateBuilder.Append("\">更多</a></div>    </div>\r\n    </div>    <div class=\"block-content clearfix\">\r\n    	<div class=\"item-list\">\r\n	    <ul class=\"clearfix\">\r\n		\r\n  ");
	DataTable redNews = get_article_list("news", 0, 6, "status=0 and is_red=1");

	int newsdr1__loop__id=0;
	foreach(DataRow newsdr1 in redNews.Rows)
	{
		newsdr1__loop__id++;
	...
	templateBuilder.Append("\">\r\n     ");
	templateBuilder.Append(Utils.DropHTML(Utils.ObjectToStr(newsdr1["title"]),30));

	templateBuilder.Append("	\r\n	</a>\r\n		</li>	\r\n        ");
	}	//end for if

	templateBuilder.Append("												\r\n</ul>    	\r\n</div>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div>-</div></div></div></div><div class=\"block last-block block-articles  list-250\" id=\"block-articles-89299\" rel=\"89299\">    <div class=\"block-head\">    <div class=\"head-inner\">\r\n	    	<h2 class=\"title\">推荐文章</h2><div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("news"));

	templateBuilder.Append("\">更多</a></div>    </div>\r\n    </div>    <div class=\"block-content clearfix\">\r\n    	<div class=\"item-list\">\r\n	    <ul class=\"clearfix\">\r\n        ");
	DataTable topNews = get_article_list("news", 0, 4, "status=0 and is_top=1");
	...
	templateBuilder.Append("\r\n		<li>\r\n	<a title=\"" + Utils.ObjectToStr(newsdr2["title"]) + "\" href=\"");
	templateBuilder.Append(linkurl("news_show",Utils.ObjectToStr(newsdr2["id"])));

	templateBuilder.Append("\">  ");
	templateBuilder.Append(Utils.DropHTML(Utils.ObjectToStr(newsdr2["title"]),30));

	templateBuilder.Append("</a>\r\n		</li>	\r\n        ");
	}	//end for if

	templateBuilder.Append("\r\n\r\n			    		</ul>    	</div>\r\n    </div>\r\n    <div class=\"block-foot\"><div><div>-</div></div></div></div>	</div>\r\n	<div class=\"main-layout clearfix\">\r\n		<div class=\"block first-block block-products list-960\" id=\"block-products-89300\" rel=\"89300\">\r\n	<div class=\"block-head\">\r\n		<div class=\"head-inner clearfix\">\r\n			<h2 class=\"title\">最新产品</h2>\r\n			<div class=\"links\"><a class=\"more\" href=\"");
	templateBuilder.Append(linkurl("products"));

	templateBuilder.Append("\">更多</a></div>		</div>\r\n	</div>\r\n	<div class=\"block-content clearfix\">\r\n		<div class=\"sys-scroll-left-wrap\">\r\n		<div class=\"sys-scroll-left\" id=\"sys-scroll-left-89300\">\r\n		<table>\r\n			<tr>\r\n				<td id=\"sys-scroll-left-89300-a\" class=\"sys-scroll-left-a\">\r\n					<table>\r\n						<tr>\r\n");
	DataTable descproducts = get_article_list("products", 0, 10, "status=0 and is_red=1", "id desc");

	int productsdrdesc2__loop__id=0;
	foreach(DataRow productsdrdesc2 in descproducts.Rows)
	{
		productsdrdesc2__loop__id++;


	templateBuilder.Append("\r\n	<td>\r\n								<div class=\"thumb\">\r\n									<a href=\"");
	templateBuilder.Append(linkurl("products_show",Utils.ObjectToStr(productsdrdesc2["id"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(productsdrdesc2["title"]) + "\"><img src=\"" + Utils.ObjectToStr(productsdrdesc2["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(productsdrdesc2["title"]) + "\" /></a>\r\n								</div>\r\n								<div class=\"title\"><a href=\"");
	templateBuilder.Append(linkurl("products_show",Utils.ObjectToStr(productsdrdesc2["id"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(productsdrdesc2["title"]) + "\">" + Utils.ObjectToStr(productsdrdesc2["title"]) + "</a></div>										</td>\r\n");
	}	//end for if

	templateBuilder.Append("\r\n </tr>      \r\n					</table>\r\n				</td>\r\n				<td id=\"sys-scroll-left-89300-b\" class=\"sys-scroll-left-b\"> </td>\r\n			</tr>\r\n		</table>\r\n		</div>\r\n		</div>\r\n		<script type=\"text/javascript\">\r\n			sysScrollLeft('sys-scroll-left-89300');\r\n		</");
	templateBuilder.Append("script>\r\n	</div>\r\n	<div class=\"block-foot\"><div><div></div></div></div>\r\n</div>	</div>\r\n</div>\r\n	</div>\r\n	</div>\r\n</div>\r\n</div>\r\n\r\n\r\n<!--Footer-->\r\n");
