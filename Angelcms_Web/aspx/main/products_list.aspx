...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable products_list = get_article_list("products", category_id, page, "status=0", out totalcount, out pagelist, "products_list", category_id, "__id__");
	...
	templateBuilder.Append("\">" + Utils.ObjectToStr(dr["title"]) + "</a></p>\r\n							<p class=\"default catalog\">价格:￥" + Utils.ObjectToStr(dr["sell_price"]) + "</p>\r\n							</div>\r\n						</li>\r\n          ");
	}	//end for if
